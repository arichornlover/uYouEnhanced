...
before-all::
	@if [[ ! -f $(UYOU_DEB) ]]; then \
 		curl -s -L "https://www.dropbox.com/scl/fi/l7gi1vftxjlc40pws1n2e/com.miro.uyou_$(UYOU_VERSION)_iphoneos-arm.deb?rlkey=fa8goy6guxdsyv5ismt21cz7j&st=w1uy8yse&dl=1" -o $(UYOU_DEB); \
 	fi; \
