...
before-all::
	@if [[ ! -f $(UYOU_DEB) ]]; then \
 		curl -s -L "https://www.dropbox.com/scl/fi/ys1t5ejdybfb7zg49114h/com.miro.uyou_$(UYOU_VERSION)_iphoneos-arm.deb?rlkey=8gy0ad0zek5zrvtm7nt02wteu&st=qxp3sap9&dl=1" -o $(UYOU_DEB); \
 	fi; \
